<template>
  ...
  <div class='earnings-summary'>
    <div class='earnings-figure'>
      <span class='amount'>{{ util.getLocaleString(totalCommission.toFixed(4)) }}</span>
    ...
    <div class='earnings-figure'>
      <span class='amount'>{{ util.getLocaleString(commissionJPY.toFixed(4)) }}</span>
...
import { useFrontendArchivementStore, useLocalUserStore, PriceCoinName, useAdminCurrencyStore, useLocaleStringStore } from 'npool-cli-v4'
