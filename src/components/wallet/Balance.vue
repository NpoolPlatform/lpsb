<template>
  ...
  <div class='earnings-summary'>
    <div class='earnings-figure'>
      <span class='amount'>{{ getLocaleString.value(totalUSDTBalance.toFixed(4), true) }}</span>
    ...
    <div class='earnings-figure'>
      <span class='amount'>{{ getLocaleString.value(totalJPYBalance.toFixed(4), true) }}</span>
...
import { PriceCoinName, useAdminCurrencyStore, useFrontendGeneralStore, getLocaleString } from 'npool-cli-v4'
