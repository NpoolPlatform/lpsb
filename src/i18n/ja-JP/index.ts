...
export default {
  ...
  MSG_PROCYON_PLATFORM: 'プラットフォーム',
  MSG_LOGIN_FAQ_MENU_TITLE: 'ログイン',
  MSG_LOGIN_FAQ_MENU_SUBTITLE: 'のログインに関する詳細を確認',
  MSG_ACCOUNT_SETTINGS_FAQ_MENU_TITLE: 'アカウント情報',
  MSG_ACCOUNT_SETTINGS_FAQ_MENU_SUBTITLE: 'のアカウント情報に関する設定方法を確認',
  MSG_DASHBOARD_FAQ_MENU_TITLE: 'ダッシュボード',
  MSG_DASHBOARD_FAQ_MENU_SUBTITLE: 'のマイニングダッシュボードに関する詳細を確認',
  MSG_PAYMENTS_FAQ_MENU_TITLE: '入出金',
  MSG_PAYMENTS_FAQ_MENU_SUBTITLE: 'での支払いに関する詳細を確認',
  MSG_KYC_FAQ_MENU_TITLE: 'KYC (本人確認)',
  MSG_KYC_FAQ_MENU_SUBTITLE: 'KYC (本人確認) の申請に関する詳細を確認',
  MSG_SECURITY_FAQ_MENU_TITLE: '情報セキュリティポリシー',
  MSG_SECURITY_FAQ_MENU_SUBTITLE: 'のセキュリティポリシーに関する詳細を確認',
  MSG_GENERAL_FAQ_MENU_TITLE: '総合案内',
  MSG_GENERAL_FAQ_MENU_SUBTITLE: 'その他に関する一般的な情報を確認',
  MSG_PROCYON_PRODUCTS: '製品一覧',
  MSG_SPACEMESH_FAQ_MENU_TITLE: 'Spacemesh概要',
  MSG_SPACEMESH_FAQ_MENU_SUBTITLE: 'のSpacemeshマイニング詳細はこちら',
